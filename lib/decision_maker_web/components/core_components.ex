defmodule DecisionMakerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DecisionMakerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DecisionMakerWeb.Gettext, "errors", msg, opts)
    end
  end
